...
public interface CommandExecutor {
    ...
    int execute(String command, int timeoutSeconds, String... args) throws Exception;
    String executeAndCapture(String command, int timeoutSeconds, String... args) throws Exception;
}
